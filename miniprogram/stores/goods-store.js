...
import { observable, action, flow, get } from 'mobx-miniprogram';
...
export default (function store() {
  ...
  return observable({
    ...
    switchGoodsSpuList: action(function ({ tag, cId, trigger }) {
      ...
      if (data && data.pageNumber !== 0) {
        ...
        this.selected_cId = cId;
        this.fetchGoodsSpuList({ tag, cId, pageNumber: 1, trigger });
      }
    }),
